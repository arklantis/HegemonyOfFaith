...
$machinestates = array(
  ...
  31 => array(
    "name" => "playerTurn",
    "description" => clienttranslate('It is ${actplayer}\'s turn'),
  ...
  35 => array(
    ...
    "description" => clienttranslate('${actplayer} has no Believers and enters the Surrender Phase'),
    "descriptionmyturn" => clienttranslate('${you} have no Believers. Choose a Sect Leader to surrender to'),
    "type" => "activeplayer",
    "action" => "stPracticeAiActivePlayer",
  ...
  38 => array(
    ...
    "description" => clienttranslate('Waiting for ${actplayer} to decide whether to accept the surrender'),
    "descriptionmyturn" => clienttranslate('${you} must decide whether to accept the surrender'),
    "type" => "activeplayer",
    "action" => "stPracticeAiActivePlayer",
  ...
  50 => array(
    ...
    "descriptionmyturn" => clienttranslate('${you} must decide whether to defend'),
  ...
  80 => array(
    ...
    "possibleactions" => array("chooseMartyrdomRepresentative", "playDefenseCard"),
  ...
  85 => array(
    ...
    "descriptionmyturn" => clienttranslate('${you}: commit one Believer or play a defense card'),
    "type" => "multipleactiveplayer",
    "action" => "stMartyrdomChooseBelievers",
    "args" => "argMartyrdomChooseBelievers",
    "possibleactions" => array("playBelieverCard", "playDefenseCard"),
    "transitions" => array(
      "nextStep" => 86
    )
  ),
  ...
  82 => array(
    ...
    "possibleactions" => array("chooseConspiracyRepresentative", "playDefenseCard"),
  ...
  94 => array(
    ...
    "description" => clienttranslate('Waiting for confrontation to continue'),
    "descriptionmyturn" => clienttranslate('${you}: use Holy Rebirth to revive 3 of your fallen Believers'),
    "type" => "activeplayer",
    "action" => "stPracticeAiActivePlayer",
  ...
  107 => array(
    ...
    "descriptionmyturn" => clienttranslate('${requester_name} wants to stop Faith Debate.'),
    "type" => "activeplayer",
    "action" => "stPracticeAiActivePlayer",
  ...
  102 => array(
    ...
    "descriptionmyturn" => clienttranslate('Review the game-end summary.'),
    "type" => "multipleactiveplayer",
