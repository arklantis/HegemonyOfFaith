...
$machinestates = array(
  ...
  50 => array(
    ...
    "descriptionmyturn" => clienttranslate('${you} must decide whether to defend against this ${defense_attack_kind} attack'),
  ...
  80 => array(
    ...
    "descriptionmyturn" => clienttranslate('${you} must choose a representative for Martyrdom'),
    "type" => "multipleactiveplayer",
  ...
  82 => array(
    ...
    "descriptionmyturn" => clienttranslate('${you} must choose a representative for Conspiracy'),
    "type" => "multipleactiveplayer",
  ...
  96 => array(
    ...
    "descriptionmyturn" => clienttranslate('${you}: use Karma Reversed to reverse the confrontation result, or skip'),
    "type" => "activeplayer",
  ...
  91 => array(
    ...
    "descriptionmyturn" => clienttranslate('${you}: use The Prophet to predict the draw, or skip'),
    "type" => "activeplayer",
  ...
  94 => array(
    ...
    "description" => clienttranslate('Waiting for confrontation to continue'),
    "descriptionmyturn" => clienttranslate('${you}: use Holy Rebirth to revive 3 Believers, or skip'),
    "type" => "activeplayer",
